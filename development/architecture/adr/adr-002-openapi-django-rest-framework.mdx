---
title: "ADR-002: Django Rest Framework with Pydantic and OpenAPI"
description: "Decision to use Django Rest Framework enhanced with Pydantic validation and OpenAPI specification for API development"
---
