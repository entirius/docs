---
title: "ADR-004: Mozilla Public License for Codebase"
description: "Decision to use Mozilla Public License 2.0 for Entirius open-source codebase"
---
...
2. **Phase 2: Documentation** (Week 2)
...
3. **Phase 3: Process Integration** (Week 3)
...
4. **Phase 4: Community Communication** (Week 4)
