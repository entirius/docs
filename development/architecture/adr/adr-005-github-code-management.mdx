---
title: "ADR-005: GitHub as Code Repository"
description: "Decision to use GitHub as the primary platform for version control and code management of Entirius backend and frontend"
---
