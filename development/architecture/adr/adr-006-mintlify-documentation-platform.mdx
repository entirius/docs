---
title: "ADR-006: Mintlify for Technical Documentation"
description: "Decision to use Mintlify as the platform for Entirius technical documentation including backend, API, and PWA documentation"
---
